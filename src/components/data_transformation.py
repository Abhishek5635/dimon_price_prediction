...
# creating preprocessor.pickle file path
@dataclass
...
class DataTransformation:
    ...
    # This process is for crating a pickle which is use for feature engineering and feature scaling
    ...
    #Train and test path come from artifacts folder    
